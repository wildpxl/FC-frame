...
class NeynarV2APIClient {
     ...
     */
    constructor(apiKey, { baseOptions, basePath, logger = logger_1.silentLogger, axiosInstance, } = {}) {
        this.logger = logger;
        if (apiKey === "") {
        ...
        this.apis = {
            action: new openapi_farcaster_1.ActionApi(config, undefined, axiosInstance),
            ...
            block: new openapi_farcaster_1.BlockApi(config, undefined, axiosInstance),
            ban: new openapi_farcaster_1.BanApi(config, undefined, axiosInstance),
            subscribers: new openapi_farcaster_1.SubscribersApi(config, undefined, axiosInstance),
            stp: new openapi_farcaster_1.StpApi(config, undefined, axiosInstance),
        };
    }
    /**
     ...
     */
    async publishFarcasterAction(signerUuid, baseUrl, action) {
        const farcasterActionReqBody = {
     ...
     */
    async registerSignedKey(signerUuid, fid, deadline, signature, options) {
        const registerSignerKeyReqBody = Object.assign({ signer_uuid: signerUuid, app_fid: fid, deadline: deadline, signature: signature }, ((options === null || options === void 0 ? void 0 : options.sponsor)
            ? {
     ...
     */
    async registerSignedKeyForDeveloperManagedSigner(publicKey, signature, appFid, deadline, options) {
        const registerSignerKeyReqBody = Object.assign({ public_key: publicKey, app_fid: appFid, deadline: deadline, signature: signature }, ((options === null || options === void 0 ? void 0 : options.sponsor)
            ? {
                sponsor: options.sponsor,
            }
            : {}));
        const response = await this.apis.signer.registerSignedKeyForDeveloperManagedSigner({
            register_developer_managed_signed_key_req_body: registerSignerKeyReqBody,
        });
        return response.data;
    }
    /**
    ...
    async fetchPowerUsers(options) {
        const response = await this.apis.user.fetchPowerUsers({
            ...
            viewer_fid: options === null || options === void 0 ? void 0 : options.viewerFid,
        });
        return response.data;
    }
    /**
     ...
     */
    async lookupUserByUsernameV2(username, options) {
     ...
     */
    async fetchUsersByLocation(latitude, longitude, options) {
     ...
     */
    async fetchUserBalance(fid, networks) {
    ...
    async fetchBulkCasts(castsHashes, options) {
        ...
        const response = await this.apis.cast.fetchBulkCasts({
            casts: _castsHashes,
            viewer_fid: options === null || options === void 0 ? void 0 : options.viewerFid,
            sort_type: options === null || options === void 0 ? void 0 : options.sortType,
        });
        return response.data;
    }
    /**
    ...
    async lookupCastConversation(castHashOrUrl, type, options) {
        const response = await this.apis.cast.lookupCastConversation({
            ...
            type,
            viewer_fid: options === null || options === void 0 ? void 0 : options.viewerFid,
            reply_depth: options === null || options === void 0 ? void 0 : options.replyDepth,
            include_chronological_parent_casts: options === null || options === void 0 ? void 0 : options.includeChronologicalParentCasts,
            sort_type: options === null || options === void 0 ? void 0 : options.sortType,
            fold: options === null || options === void 0 ? void 0 : options.fold,
            limit: options === null || options === void 0 ? void 0 : options.limit,
            cursor: options === null || options === void 0 ? void 0 : options.cursor,
        });
        return response.data;
     ...
     */
    async searchCasts(q, options) {
        const response = await this.apis.cast.searchCasts({
            q,
            author_fid: options === null || options === void 0 ? void 0 : options.authorFid,
            viewer_fid: options === null || options === void 0 ? void 0 : options.viewerFid,
            parent_url: options === null || options === void 0 ? void 0 : options.parentUrl,
            channel_id: options === null || options === void 0 ? void 0 : options.channelId,
            priority_mode: options === null || options === void 0 ? void 0 : options.priorityMode,
            limit: options === null || options === void 0 ? void 0 : options.limit,
            cursor: options === null || options === void 0 ? void 0 : options.cursor,
        });
        return response.data;
     ...
     *
     */
    async fetchComposerActions(list, options) {
    ...
    async fetchFeed(feedType, options) {
        ...
        const response = await this.apis.feed.fetchFeed({
            feed_type: feedType,
            filter_type: options === null || options === void 0 ? void 0 : options.filterType,
            fid: options === null || options === void 0 ? void 0 : options.fid,
            fids: _fids,
            parent_url: options === null || options === void 0 ? void 0 : options.parentUrl,
            channel_id: options === null || options === void 0 ? void 0 : options.channelId,
            members_only: options === null || options === void 0 ? void 0 : options.membersOnly,
            embed_url: options === null || options === void 0 ? void 0 : options.embedUrl,
            embed_types: options === null || options === void 0 ? void 0 : options.embedTypes,
            with_recasts: options === null || options === void 0 ? void 0 : options.withRecasts,
            limit: options === null || options === void 0 ? void 0 : options.limit,
            cursor: options === null || options === void 0 ? void 0 : options.cursor,
            viewer_fid: options === null || options === void 0 ? void 0 : options.viewerFid,
        });
    ...
    async fetchFeedByChannelIds(channelIds, options) {
        ...
        const response = await this.apis.feed.fetchFeedByChannelIds({
            ...
            with_recasts: options === null || options === void 0 ? void 0 : options.withRecasts,
            with_replies: options === null || options === void 0 ? void 0 : options.withReplies,
            members_only: options === null || options === void 0 ? void 0 : options.membersOnly,
            limit: options === null || options === void 0 ? void 0 : options.limit,
            cursor: options === null || options === void 0 ? void 0 : options.cursor,
            viewer_fid: options === null || options === void 0 ? void 0 : options.viewerFid,
            should_moderate: options === null || options === void 0 ? void 0 : options.shouldModerate,
        });
        return response.data;
    }
     ...
     * */
    async fetchFeedByParentUrls(parentUrls, options) {
    ...
    async fetchFeedForYou(fid, options) {
        const response = await this.apis.feed.fetchFeedForYou({
            ...
            provider_metadata: options === null || options === void 0 ? void 0 : options.providerMetadata,
        });
        return response.data;
    }
    /**
    ...
    async fetchCastsForUser(fid, options) {
        const response = await this.apis.feed.fetchCastsForUser({
            ...
            limit: options === null || options === void 0 ? void 0 : options.limit,
            cursor: options === null || options === void 0 ? void 0 : options.cursor,
            include_replies: options === null || options === void 0 ? void 0 : options.includeReplies,
            parent_url: options === null || options === void 0 ? void 0 : options.parentUrl,
            channel_id: options === null || options === void 0 ? void 0 : options.channelId,
        });
        return response.data;
    ...
    async fetchTrendingFeed(options) {
        const response = await this.apis.feed.fetchTrendingFeed({
            ...
            cursor: options === null || options === void 0 ? void 0 : options.cursor,
            limit: options === null || options === void 0 ? void 0 : options.limit,
            time_window: options === null || options === void 0 ? void 0 : options.timeWindow,
            viewer_fid: options === null || options === void 0 ? void 0 : options.viewerFid,
            provider: options === null || options === void 0 ? void 0 : options.provider,
            provider_metadata: options === null || options === void 0 ? void 0 : options.providerMetadata,
        });
    ...
    async fetchChannelNotificationsForUser(fid, channelIds, options) {
        const _channelIds = channelIds.join(",");
        const response = await this.apis.notifications.fetchChannelNotificationsForUser({
            fid,
            channel_ids: _channelIds,
            priority_mode: options === null || options === void 0 ? void 0 : options.priorityMode,
            cursor: options === null || options === void 0 ? void 0 : options.cursor,
    ...
    async fetchNotificationsByParentUrlForUser(fid, parentUrls, options) {
        const _parentUrls = parentUrls.join(",");
        const response = await this.apis.notifications.fetchNotificationsByParentUrlForUser({
            fid,
            parent_urls: _parentUrls,
            priority_mode: options === null || options === void 0 ? void 0 : options.priorityMode,
            cursor: options === null || options === void 0 ? void 0 : options.cursor,
     ...
     */
    async markNotificationsAsSeen(signerUuid, options) {
        const reqBody = Object.assign({ signer_uuid: signerUuid }, ((options === null || options === void 0 ? void 0 : options.type) && { type: options.type }));
     ...
     */
    async followChannel(signerUuid, channelId) {
        const reqBody = {
            signer_uuid: signerUuid,
     ...
     */
    async unfollowChannel(signerUuid, channelId) {
        const reqBody = {
            signer_uuid: signerUuid,
            channel_id: channelId,
        };
     ...
     */
    async fetchChannelInvites(options) {
        const response = await this.apis.channel.fetchChannelInvites({
            channel_id: options === null || options === void 0 ? void 0 : options.channelId,
            invited_fid: options === null || options === void 0 ? void 0 : options.invitedFid,
            limit: options === null || options === void 0 ? void 0 : options.limit,
            cursor: options === null || options === void 0 ? void 0 : options.cursor,
        });
        return response.data;
     ...
     */
    async fetchChannelMembers(channelId, options) {
     ...
     */
    async searchChannels(q, options) {
     ...
     */
    async fetchRelevantFollowersForAChannel(id, viewerFid) {
     ...
     */
    async inviteChannelMember(signerUuid, channelId, fid, role) {
        const inviteChannelMemberRequest = {
            signer_uuid: signerUuid,
            channel_id: channelId,
            fid: fid,
            role: role,
     ...
     */
    async removeChannelMember(signerUuid, channelId, fid, role) {
        const inviteChannelMemberRequest = {
            signer_uuid: signerUuid,
            channel_id: channelId,
            fid: fid,
     ...
     */
    async respondChannelInvite(signerUuid, channelId, role, accept) {
        const respondChannelInviteRequest = {
            signer_uuid: signerUuid,
            channel_id: channelId,
            role: role,
            accept: accept,
     ...
     */
    async fetchUserChannelMemberships(fid, options) {
     ...
     *
     */
    async fetchFollowSuggestions(fid, options) {
     ...
     *
     */
    async buyStorage(fid, options) {
        const buyStorageReqBody = Object.assign(Object.assign({ fid }, (typeof (options === null || options === void 0 ? void 0 : options.units) !== "undefined" && { units: options.units })), (typeof (options === null || options === void 0 ? void 0 : options.idem) !== "undefined" && { idem: options.idem }));
    ...
    async lookupNeynarFrame(identifier, options) {
        ...
        const response = await this.apis.frame.lookupNeynarFrame({
            type,
            uuid: type === openapi_farcaster_1.FrameType.Uuid ? identifier : undefined,
            url: type === openapi_farcaster_1.FrameType.Url ? identifier : undefined,
        });
        return response.data;
    }
    /**
     ...
     *
     */
    async fetchFrameMetaTagsFromUrl(url) {
    ...
    async postFrameAction(signerUuid, castHash, action) {
        const body = Object.assign({ signer_uuid: signerUuid, action }, (typeof castHash !== "undefined" && { cast_hash: castHash }));
     ...
     */
    async postFrameActionDeveloperManaged(action, signature_packet, options) {
        const body = Object.assign({ action,
            signature_packet }, (typeof (options === null || options === void 0 ? void 0 : options.castHash) !== "undefined" && {
            cast_hash: options === null || options === void 0 ? void 0 : options.castHash,
        }));
    ...
    async fetchValidateFrameAnalytics(frameUrl, analyticsType, start, stop, options) {
        const response = await this.apis.frame.fetchValidateFrameAnalytics({
            ...
            start,
            stop,
            aggregate_window: options === null || options === void 0 ? void 0 : options.aggregateWindow,
        });
        return response.data;
    }
    // ------------ Webhook ------------
     ...
     */
    async fetchBlockList(options) {
        const response = await this.apis.block.fetchBlockList({
            blocked_fid: options === null || options === void 0 ? void 0 : options.blockedFid,
            blocker_fid: options === null || options === void 0 ? void 0 : options.blockerFid,
            limit: options === null || options === void 0 ? void 0 : options.limit,
            cursor: options === null || options === void 0 ? void 0 : options.cursor,
        });
        return response.data;
     ...
     */
    async publishBlock(signerUuid, blockedFid) {
        const addBlockBody = {
            signer_uuid: signerUuid,
     ...
     */
    async deleteBlock(signerUuid, blockedFid) {
     ...
     */
    async fetchSubscriptionCheck(addresses, contractAddress, chainId) {
