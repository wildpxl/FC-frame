import { CastApi, SignerApi, Signer, Cast, CastParamType, PostCastResponseCast, ReactionApi, ReactionType, OperationResponse, BulkFollowResponse, ErrorRes, FeedApi, UserApi, FeedResponse, NotificationsResponse, NotificationsApi, FollowsApi, RelevantFollowersResponse, UserSearchResponse, CastResponse, CastsResponse, CastsSearchResponse, UserResponse, BulkUsersResponse, FeedType, FilterType, ReactionsType, ReactionsResponse, StorageApi, StorageAllocationsResponse, StorageUsageResponse, ChannelApi, ChannelResponse, ChannelListResponse, User, BulkCastsResponse, FnameApi, FnameAvailabilityResponse, FrameApi, FrameAction, ValidateFrameActionResponse, UsersResponse, DeveloperManagedSigner, WebhookApi, WebhookResponse, WebhookSubscriptionFilters, WebhookListResponse, Conversation, ReactionsCastResponse, FrameValidateListResponse, ValidateFrameAnalyticsType, FrameValidateAnalyticsResponse, AuthorizationUrlResponse, AuthorizationUrlResponseType, TrendingChannelResponse, MuteApi, MuteListResponse, MuteResponse, BlockApi, BlockListResponse, BanApi, BanResponse, BanListResponse, FollowSortType, ChannelSearchResponse, ChannelType, ChannelResponseBulk, FrameType, SubscribersApi, SubscriptionProvider, SubscribersResponse, SubscribedToResponse, SubscriptionsResponse, SubscriptionProviders, ForYouProvider, FrameSignaturePacket, FeedTrendingProvider, CastComposerType, CastComposerActionsListResponse, UserPowerLiteResponse, NotificationType, EmbedType, ChannelMemberRole, CastConversationSortType, ChannelMemberListResponse, FollowersResponse, FarcasterActionReqBodyAction, ActionApi, UpdateUserReqBodyLocation, PostCastReqBodyEmbeds, NeynarFrameUpdateReqBody, NeynarFrameCreationReqBody, StpApi, SubscriptionStatus, BalanceResponse, Networks, FetchFrameMetaTagsFromUrl200Response } from "./openapi-farcaster";
...
export declare class NeynarV2APIClient {
     ...
     */
    constructor(apiKey: string, { baseOptions, basePath, logger, axiosInstance, }?: {
        baseOptions?: any;
        basePath?: string;
        logger?: Logger;
     ...
     */
    publishFarcasterAction(signerUuid: string, baseUrl: string, action: FarcasterActionReqBodyAction): Promise<{
        [key: string]: any;
    }>;
    /**
     ...
     */
    registerSignedKey(signerUuid: string, fid: number, deadline: number, signature: string, options?: {
        sponsor?: {
            fid: number;
            signature: string;
        };
     ...
     */
    registerSignedKeyForDeveloperManagedSigner(publicKey: string, signature: string, appFid: number, deadline: number, options?: {
        sponsor?: {
            fid: number;
            signature: string;
        };
     ...
     */
    lookupUserByUsernameV2(username: string, options?: {
        viewerFid?: number;
     ...
     */
    fetchUsersByLocation(latitude: number, longitude: number, options?: {
        viewerFid?: number;
        limit?: number;
        cursor?: string;
    }): Promise<UsersResponse>;
     ...
     */
    fetchUserBalance(fid: number, networks: Networks[]): Promise<BalanceResponse>;
    /**
     ...
     *
     */
    fetchComposerActions(list: CastComposerType, options?: {
        limit?: number;
        cursor?: string;
     ...
     * */
    fetchFeedByParentUrls(parentUrls: string[], options?: {
        withRecasts?: boolean;
        withReplies?: boolean;
        limit?: number;
        cursor?: string;
     ...
     */
    markNotificationsAsSeen(signerUuid: string, options?: {
     ...
     */
    followChannel(signerUuid: string, channelId: string): Promise<OperationResponse>;
    /**
     * Unfollow a channel.
     *
     ...
     */
    unfollowChannel(signerUuid: string, channelId: string): Promise<OperationResponse>;
    /**
     ...
     */
    fetchChannelInvites(options?: {
        channelId?: string;
        invitedFid?: number;
        limit?: number;
        cursor?: string;
    }): Promise<import("./openapi-farcaster").ChannelMemberInviteListResponse>;
    /**
     ...
     */
    fetchChannelMembers(channelId: string, options?: {
        fid?: number;
        limit?: number;
        cursor?: string;
     ...
     */
    searchChannels(q: string, options?: {
        limit?: number;
        cursor?: string;
     ...
     */
    fetchRelevantFollowersForAChannel(id: string, viewerFid: number): Promise<RelevantFollowersResponse>;
    /**
     ...
     */
    inviteChannelMember(signerUuid: string, channelId: string, fid: number, role: ChannelMemberRole): Promise<OperationResponse>;
    /**
     ...
     */
    removeChannelMember(signerUuid: string, channelId: string, fid: number, role: ChannelMemberRole): Promise<OperationResponse>;
    /**
     ...
     */
    respondChannelInvite(signerUuid: string, channelId: string, role: ChannelMemberRole, accept: boolean): Promise<OperationResponse>;
    /**
     ...
     */
    fetchUserChannelMemberships(fid: number, options?: {
        limit?: number;
        cursor?: string;
    }): Promise<ChannelMemberListResponse>;
    /**
     ...
     *
     */
    fetchFollowSuggestions(fid: number, options?: {
        limit?: number;
        viewerFid?: number;
    }): Promise<UsersResponse>;
    /**
     ...
     */
    publishNeynarFrame(neynarFrameCreationRequest: NeynarFrameCreationReqBody): Promise<import("./openapi-farcaster").NeynarFrame>;
    /**
     ...
     */
    updateNeynarFrame(neynarFrameUpdateRequest: NeynarFrameUpdateReqBody): Promise<import("./openapi-farcaster").NeynarFrame>;
    /**
     ...
     *
     */
    fetchFrameMetaTagsFromUrl(url: string): Promise<FetchFrameMetaTagsFromUrl200Response>;
    /**
     ...
     */
    postFrameAction(signerUuid: string, castHash: string | undefined, action: FrameAction): Promise<import("./openapi-farcaster").Frame>;
    /**
     ...
     */
    postFrameActionDeveloperManaged(action: FrameAction, signature_packet: FrameSignaturePacket, options?: {
        castHash?: string;
    }): Promise<import("./openapi-farcaster").Frame>;
    /**
     ...
     */
    publishBlock(signerUuid: string, blockedFid: number): Promise<OperationResponse>;
    /**
     ...
     */
    deleteBlock(signerUuid: string, blockedFid: number): Promise<OperationResponse>;
    /**
     ...
     *
     */
    publishBans(fids: number[]): Promise<BanResponse>;
    /**
     ...
     */
    deleteBans(fids: number[]): Promise<BanResponse>;
    /**
     ...
     */
    fetchSubscriptionCheck(addresses: string[], contractAddress: string, chainId: string): Promise<{
