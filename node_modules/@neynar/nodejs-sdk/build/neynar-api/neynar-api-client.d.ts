import { Signer, Cast, CastParamType, PostCastResponseCast, ReactionType, OperationResponse, BulkFollowResponse, FeedResponse, NotificationsResponse, RelevantFollowersResponse, UserSearchResponse, CastResponse, CastsResponse, CastsSearchResponse, UserResponse, BulkUsersResponse, FeedType, FilterType, ReactionsResponse, ReactionsType, StorageAllocationsResponse, StorageUsageResponse, ChannelResponse, ChannelListResponse, User as UserV2, BulkCastsResponse, FnameAvailabilityResponse, FrameAction, Frame, ValidateFrameActionResponse, UsersResponse, UsersActiveChannelsResponse, NeynarFrame, DeleteFrameResponse, UserFIDResponse, RegisterUserResponse, DeveloperManagedSigner, WebhookResponse, WebhookSubscriptionFilters, WebhookListResponse, Conversation, ReactionsCastResponse, FrameValidateAnalyticsResponse, ValidateFrameAnalyticsType, FrameValidateListResponse, AuthorizationUrlResponse, AuthorizationUrlResponseType, TrendingChannelResponse, MuteListResponse, MuteResponse, BlockListResponse, BanListResponse, BanResponse, FollowSortType, CastConversationSortType, ChannelSearchResponse, ChannelType, ChannelResponseBulk, FrameType, SubscriptionProvider, SubscribersResponse, SubscribedToResponse, SubscriptionsResponse, SubscriptionProviders, ForYouProvider, FrameSignaturePacket, FeedTrendingProvider, CastComposerType, CastComposerActionsListResponse, SubscriptionStatus, UserPowerLiteResponse, NotificationType, EmbedType, ChannelMemberRole, ChannelMemberInviteListResponse, ChannelMemberListResponse, FollowersResponse, FarcasterActionReqBodyAction, UpdateUserReqBodyLocation, PostCastReqBodyEmbeds, NeynarFrameUpdateReqBody, NeynarFrameCreationReqBody, BalanceResponse, Networks, FetchFrameMetaTagsFromUrl200Response } from "./v2/openapi-farcaster";
import { RecentUsersResponse, UserCastLikeResponse, Cast as CastV1, CastsResponse as CastsResponseV1, RecentCastsResponse, MentionsAndRepliesResponse, ReactionsAndRecastsResponse, FollowResponse, UserResponse as UserResponseV1, CustodyAddressResponse, CastResponse as CastResponseV1, VerificationResponse, AllCastsInThreadResponse } from "./v1/openapi";
...
export declare class NeynarAPIClient {
     ...
     */
    publishFarcasterAction(signerUuid: string, base_url: string, action: FarcasterActionReqBodyAction): Promise<Object>;
    /**
     ...
     */
    publishNeynarFrame(neynarFrameCreationRequest: NeynarFrameCreationReqBody): Promise<NeynarFrame>;
    /**
     ...
     */
    updateNeynarFrame(neynarFrame: NeynarFrameUpdateReqBody): Promise<NeynarFrame>;
    /**
     ...
     */
    postFrameAction(signerUuid: string, castHash: string | undefined, action: FrameAction): Promise<Frame>;
    /**
