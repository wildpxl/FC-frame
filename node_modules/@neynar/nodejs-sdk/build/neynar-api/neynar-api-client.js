...
class NeynarAPIClient {
    ...
    constructor(apiKey, { baseOptions, basePath, logger = logger_1.silentLogger, axiosInstance, } = {}) {
        ...
        this.clients = {
            v1: new v1_1.NeynarV1APIClient(apiKey, {
                basePath,
                logger,
                axiosInstance,
            }),
            v2: new v2_1.NeynarV2APIClient(apiKey, {
                baseOptions,
                basePath,
                logger,
                axiosInstance,
     ...
     */
    async publishFarcasterAction(signerUuid, base_url, action) {
        return await this.clients.v2.publishFarcasterAction(signerUuid, base_url, action);
    }
    // ------------ Signer ------------
    /**
    ...
    async registerSignedKey(signerUuid, fid, deadline, signature, options) {
        return await this.clients.v2.registerSignedKey(signerUuid, fid, deadline, signature, options);
    }
    ...
    async registerSignedKeyForDeveloperManagedSigner(publicKey, signature, appFid, deadline, options) {
        return await this.clients.v2.registerSignedKeyForDeveloperManagedSigner(publicKey, signature, appFid, deadline, options);
    }
    /**
    ...
    async inviteChannelMember(signerUuid, channelId, fid, role) {
        return await this.clients.v2.inviteChannelMember(signerUuid, channelId, fid, role);
    }
    /**
    ...
    async removeChannelMember(signerUuid, channelId, fid, role) {
        return await this.clients.v2.removeChannelMember(signerUuid, channelId, fid, role);
    }
    /**
    ...
    async respondChannelInvite(signerUuid, channelId, role, accept) {
        return await this.clients.v2.respondChannelInvite(signerUuid, channelId, role, accept);
    }
    // ------------ Follows ------------
    /**
    ...
    async postFrameActionDeveloperManaged(action, signature_packet, options) {
        return await this.clients.v2.postFrameActionDeveloperManaged(action, signature_packet, options);
    }
    /**
    ...
    async fetchSubscriptionCheck(addresses, contractAddress, chainId) {
        return await this.clients.v2.fetchSubscriptionCheck(addresses, contractAddress, chainId);
    }
}
