        ...
        return __asyncGenerator(this, arguments, function* getHeaders_1() {
            ...
            for (let i = 32; i < 32 + 64 * (yield __await(this.length())); i += 64) {
                yield yield __await({
                    ...
                    id: yield __await(read(handle.fd, Buffer.allocUnsafe(32), 0, 32, i + 32).then((r) => bs58_1.default.encode(r.buffer))),
                });
            }
        ...
        return __asyncGenerator(this, arguments, function* itemsGenerator_1() {
            ...
            try {
                for (var _d = true, _e = __asyncValues(this.getHeaders()), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    ...
                    try {
                        const { id } = _c;
                        yield yield __await(new FileDataItem_1.default(this.txs[counter], bs58_1.default.decode(id)));
                        counter++;
                    }
                    finally {
                        _d = true;
            ...
            try {
                for (var _d = true, _e = __asyncValues(this.getHeaders()), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                    ...
                    try {
                        const { id } = _c;
                        if (id === txId)
                            return new FileDataItem_1.default(this.txs[counter], bs58_1.default.decode(id));
                        counter++;
                    }
                    finally {
                        _d = true;
            ...
            try {
                for (var _d = true, _e = __asyncValues(this.getHeaders()), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                    ...
                    try {
                        const { id } = _c;
                        if (count === index) {
                            return new FileDataItem_1.default(this.txs[count], bs58_1.default.decode(id));
                        }
                        count++;
                    }
                    finally {
