...
class Bundle {
    ...
    getIds() {
        ...
        for (let i = HEADER_START; i < HEADER_START + 64 * this.length; i += 64) {
            ...
            ids.push(bs58_1.default.encode(bundleId));
        }
        return ids;
    }
    getIdBy(index) {
        ...
        return bs58_1.default.encode(this.binary.subarray(start, start + 32));
    }
    ...
    verify() {
        return __awaiter(this, void 0, void 0, function* () {
            for (const item of this.items) {
                ...
                const expected = bs58_1.default.encode((0, crypto_1.createHash)("sha256").update(item.rawSignature).digest());
