...
function processStream(stream) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < headersLength; i += 64) {
            headers[i / 64] = [(0, utils_1.byteArrayToLong)(bytes.subarray(i, i + 32)), bs58_1.default.encode(Buffer.from(bytes.subarray(i + 32, i + 64)))];
        }
        ...
        for (const [length, id] of headers) {
            ...
            transform.end();
            // Check id
            if (id !== bs58_1.default.encode((0, crypto_1.createHash)("sha256").update(signature).digest()))
